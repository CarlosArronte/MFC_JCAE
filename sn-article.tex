...
The proposed UCC is evaluated through the SWD maneuver under the three friction conditions described above. The results compare the open-loop vehicle response, the gain-scheduled LQR benchmark, and the iPD-based MFC controller. As shown below, the open-loop case and the gain-scheduled LQR benchmark do not guarantee stability across all friction scenarios.
